...
| `plans/phase8-monitoring-pilot-validation.md` | 4-phase implementation plan for monitoring, feedback, scraper health, and pilot report (Phase 8) | When implementing Phase 8 |
